          ...
          {data.farmerWindowRepaymentStructure ? (
            <div className="row">
              <div className="col-lg-6">
                ...
                <RepaymentContentTitle
                  ...
                  val={data.requestedAmount}
                />
                <RepaymentContentTitle
                  title="Loan Granted Amount"
              ...
              <div className="col-lg-6">
                ...
                <RepaymentContentTitle
                  ...
                  val={data?.farmerWindowRepaymentStructure.length}
                />
                <RepaymentContentTitle
            ...
            <div className="row">
              <div className="col-lg-6">
                ...
                <RepaymentContentTitle
                  title="Requested Amount"
                  val={data.requestedAmount || 0}
                />
                <RepaymentContentTitle
                  title="Loan Granted Amount"
                  val={data.grantedAmount === -1 ? 0 : data.grantedAmount}
                />
              </div>
                ...
                <RepaymentContentTitle
                  ...
                  val={
                    data?.FPOrepaymentStructure?.filter(
                      (repayment) => repayment.emi !== 0
                    ).length || 0
                  }
                />
                <RepaymentContentTitle
                  title="Annual Interest Rate"
                  val={`${data?.intrest ? data?.intrest : 0}%`}
                />
              </div>
            </div>
          )}
