...
function CompletedLoanApp({ showCompletedLoanDetails, handleCloseCompletedLoanDetails, currentLoan, fpoId, firstPage, setFirstPage, handleShowPaymentProof, currentTransaction }) {
  return (
