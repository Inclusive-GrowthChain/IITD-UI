...
function PendingLoanApp({ showPendLoanApp, handleClosePendLoanApp, step, setStep, noOfRows, changeLoanStatus, currentPendLoanApp }) {
  return (
    <Modal
      size="lg"
                ...
                <div className="form">
                  <label className="form-label select-label">
                    <div className="">
                      ...
                      <div className="row m-2">
                        <div className="col-lg-6">
                          <label>Loan Window Period in Months</label>
                        </div>
                        <div className="col-lg-6">
                          <input
                            type="text"
